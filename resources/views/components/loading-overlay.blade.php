<div class="absolute inset-0 bg-white bg-opacity-90 flex items-center justify-center rounded-lg z-50">
    <div class="flex flex-col items-center space-y-3">
        ...
        <span class="text-sm text-gray-600 font-medium">{{ $slot ?? 'Loading...' }}</span>
    </div>
</div>
