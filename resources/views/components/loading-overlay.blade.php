<div class="absolute inset-0 bg-[var(--color-surface)]/90 border border-[var(--color-line)] flex items-center justify-center rounded-[var(--radius-lg)] z-50">
    <div class="flex flex-col items-center gap-3">
        ...
        <span class="text-sm font-medium text-[var(--color-muted)]">{{ $slot ?? 'Loading...' }}</span>
    </div>
</div>
