    ...
    <div class="os-card overflow-hidden">
        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-[var(--color-line)]">
                ...
                <tr><td class="px-5 py-3 font-mono text-xs text-[var(--color-ink)]">logout(redirectUrl?)</td><td class="px-5 py-3 text-[var(--color-muted)] text-xs font-mono">void</td><td class="px-5 py-3 text-[var(--color-ink-2)]">End only this client application's session, then redirect</td></tr>
                <tr><td class="px-5 py-3 font-mono text-xs text-[var(--color-ink)]">logoutEverywhere(redirectUrl?)</td><td class="px-5 py-3 text-[var(--color-muted)] text-xs font-mono">Promise&lt;void&gt;</td><td class="px-5 py-3 text-[var(--color-ink-2)]">Also end the shared One System SSO session</td></tr>
